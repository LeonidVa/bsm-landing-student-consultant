          ...
          <ul>
            {(this.props.form.files || []).map((f, i) => (
              ...
              >
                {f.name}
                <BlockFormClose>
                <svg aria-hidden="true" data-icon="window-close" class="svg-inline--fa fa-window-close fa-w-16 block-form__close" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
