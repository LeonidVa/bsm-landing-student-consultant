        ...
        <span style={{visibility:"hidden", height:0, width:0}} itemScope itemType = "http://schema.org/BreadcrumbList">
            ...
            <span style={{visibility:"hidden", height:0, width:0}} itemProp = "itemListElement" itemScope
                ...
                <a visibility = "hidden" height = "0" width = "0" itemProp = "item" href= "https://besmarter.ru/kursovaya-rabota-na-zakaz">
                    <span style={{visibility:"hidden", height:0, width:0}} itemProp = "name">Курсовая работа</span></a>
            ...
            <span style={{visibility:"hidden", height:0, width:0}} itemProp = "itemListElement" itemScope
                ...
                <a visibility = "hidden" height = "0" width = "0" itemProp = "item" href= "https://besmarter.ru/kursovaya-rabota-na-zakaz/buhgalterskiy-uchet">
                    <span style={{visibility:"hidden", height:0, width:0}} itemProp = "name">По бухгалтерскому учету</span></a>
