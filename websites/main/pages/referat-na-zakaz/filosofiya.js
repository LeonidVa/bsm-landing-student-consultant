        ...
        <span style={{visibility:"hidden", height:0, width:0}} itemScope itemType = "http://schema.org/BreadcrumbList">
            ...
            <span style={{visibility:"hidden", height:0, width:0}} itemProp = "itemListElement" itemScope
                ...
                <a visibility = "hidden" height = "0" width = "0" itemProp = "item" href= "https://besmarter.ru/referat-na-zakaz">
                    <span style={{visibility:"hidden", height:0, width:0}} itemProp = "name">Реферат</span></a>
                <meta visibility = "hidden" height = "0" width = "0" itemProp = "position" content = "2"/>
            </span>
            <span style={{visibility:"hidden", height:0, width:0}} itemProp = "itemListElement" itemScope
                  itemType = "http://schema.org/ListItem">
                <a visibility = "hidden" height = "0" width = "0" itemProp = "item" href= "https://besmarter.ru/referat-na-zakaz/filosofiya">
                    <span style={{visibility:"hidden", height:0, width:0}} itemProp = "name">По философии</span></a>
